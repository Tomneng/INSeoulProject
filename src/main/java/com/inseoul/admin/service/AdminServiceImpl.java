...
public class AdminServiceImpl implements AdminService {
    ...
    @Override
    public List<Complain> list(Integer page, Model model) {
        ...
        long cnt = adminRepository.allComplains();   // 글 목록 전체의 개수
        ...
        if(cnt > 0){  // 데이터가 최소 1개 이상 있는 경우만 페이징
            ...
            // 해당페이지의 글 목록 읽어오기
            list = adminRepository.complains(fromRow, pageRows);
    ...
    @Override
    public Complain findComById(Long complainId) {
        return adminRepository.findByIdCom(complainId);
    }

    @Override
    public int answered(Complain complain) {
        return adminRepository.resolved(complain);
    }
}
