...
//        model.addAttribute("review", reviewService.selectById(review.getReviewId()));
    ...
    public String reviewDetail(
        ...
        // 리뷰를 저장하는 로직
       reviewService.write(foodId, user, reviewStar, reviewCategory, reviewContent);
        System.out.println("저장되나" + reviewService.write(foodId, user, reviewStar, reviewCategory, reviewContent));
